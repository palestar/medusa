...
#define COREMEMORY_DLL				

// dlmalloc options
#define USE_DL_PREFIX				// prefix all malloc functions with "dl"
#define USE_MALLOC_LOCK		// make safe for multi-threading
#define NEEDED
...
// supress the only warning we get 
#pragma warning( disable: 4047 )		// warning C4047: 'function' : 'volatile LONG *' differs in levels of indirection from 'void ** '
