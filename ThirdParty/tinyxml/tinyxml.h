...
// easiest way to get this turned on, rather than having to set it for each project including this lib.
// but, also note that it's wrapped in an if gate because it needs to be defined in the TinyXML project.
