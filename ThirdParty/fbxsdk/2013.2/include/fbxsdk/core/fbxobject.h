...
public:
	...
	//@{
		...
		*					the source object properties values. Since this is a virtual function, some classes might do additional tasks.
		*					For instance, FbxNode::Clone will also close its node attribute. */
