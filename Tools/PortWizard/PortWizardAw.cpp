// PortWizardaw.cpp : implementation file
//
...
void CPortWizardAppWiz::InitCustomAppWiz()
{
...
void CPortWizardAppWiz::ExitCustomAppWiz()
{
	// TODO: Add code here to deallocate resources used by the custom AppWizard
}

// This is called when the user clicks "Create..." on the New Project dialog
CAppWizStepDlg* CPortWizardAppWiz::Next(CAppWizStepDlg* pDlg)
{
...
void CPortWizardAppWiz::CustomizeProject(IBuildProject* pProject)
{
	...
	for (long j = 1 ; j < lNumConfigs + 1 ; j++)
	{
		...
		pConfig->AddToolSettings( CComBSTR(L"link.exe"), CComBSTR(L"/libpath:..\\Bin"), reserved);
		if ( debug )
			pConfig->AddToolSettings( CComBSTR(L"link.exe"), CComBSTR(L"MemoryTrackerD.lib DebugD.lib FactoryD.lib ResourceD.lib StandardD.lib FileD.lib"), reserved);
		else
			pConfig->AddToolSettings( CComBSTR(L"link.exe"), CComBSTR(L"Debug.lib Factory.lib Resource.lib Standard.lib File.lib"), reserved);
...
// Here we define one instance of the CPortWizardAppWiz class.  You can access
//  m_Dictionary and any other public members of this class through the
//  global PortWizardaw.
CPortWizardAppWiz PortWizardaw;
