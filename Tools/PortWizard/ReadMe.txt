========================================================================
                    CUSTOM APPWIZARD: PortWizard
========================================================================


AppWizard has created a PortWizard DLL for you.  This DLL is the starting point
...
you build PortWizard.awx, it will automatically be copied to your Template
...
PortWizardAw.h, PortWizardAw.cpp - the CCustomAppWiz class
    These files contain your CCustomAppWiz-derived class,
    CPortWizardAppWiz.  This class contains virtual member functions which
...
Template\
    ...
    import that file as a "TEMPLATE" custom resource into PortWizard.rc.  Be
...
Template\NewProj.inf
    ...
    generated from the project "D:\Projects\Hydra\Tools\TemplatePort\TemplatePort.dsp".
...
off of the project "D:\Projects\Hydra\Tools\TemplatePort\TemplatePort.dsp".
...
StdAfx.h, StdAfx.cpp
    ...
    named PortWizard.pch and a precompiled types file named StdAfx.obj.
