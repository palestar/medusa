...
DllMain(HINSTANCE hInstance, DWORD dwReason, LPVOID lpReserved)
{
	...
	if (dwReason == DLL_PROCESS_ATTACH)
	{
		...
		Port::registerPort( CLASS_KEY( $$root$$ ), Icon );
		//Port::registerImportExt( CLASS_KEY( $$root$$ ), ".XXX" );	// TODO: For each supported extension call registerPortExtension()
	}
	else if (dwReason == DLL_PROCESS_DETACH)
	{
		...
		Port::unregisterPort( CLASS_KEY( $$root$$ ) );
