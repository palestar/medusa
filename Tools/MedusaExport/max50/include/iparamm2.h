...
class IParamMap2 : public InterfaceServer
{
	public:
		...
		// sent to a MaxMaterial Editor map to find the SubTex or SubMtl index corresponding to the control hw	
...
//  Auto ParamDlg class for MaxMaterial Editor auto-UI, instanced by ClassDesc2::CreateParamDlg()
