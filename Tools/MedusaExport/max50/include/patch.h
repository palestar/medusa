...
//watje 4-16-99 to handle hooks and changes in topology
		...
		CoreExport void		render(GraphicsWindow *gw, MaxMaterial *ma, RECT *rp, int compFlags, int numMat=1);
		CoreExport void		renderGizmo(GraphicsWindow *gw);
		CoreExport BOOL		select(GraphicsWindow *gw, MaxMaterial *ma, HitRegion *hr, int abortOnHit=FALSE, int numMat=1);
