...
class bmmHistoryList {
	...
	public:
		...
		BMMExport void	SetPath		( TCHAR *path ) { strcpy_s(initDir,sizeof(initDir), path); }
		BMMExport int	Count		( );
...
//-- Drivers that may have a different image for a same given Max frame and same Standard/device
...
class RenderInfo {
   ...
   Box2 region;  // sub-region in image that was rendered if last render was a region render. Empty if not a region render. -- DS--7/13/00
...
class Bitmap : public BaseInterfaceServer {
   ...
   public:
      ...
      //
      //  To write a single image to a Standard/device:
      //
      //  *> Create BitmapInfo class: BitmapInfo bi;
      //
      //  *> Define output Standard/device:
      //
      ...
      //
      //  To write a sequence of images to a Standard/device:
      //
      //  *> Create BitmapInfo class: BitmapInfo bi;
      //
      //  *> Define output Standard/device:
