 ...
 *<
	...
	DESCRIPTION: MaxMaterial and texture class definitions
...
class  MaxMaterial : public BaseInterfaceServer {
protected:

public:
	DllExport MaxMaterial();
	virtual ~MaxMaterial() {};
	DllExport MaxMaterial& operator=(const MaxMaterial &from);
