...
// mjm - end
		...
		virtual MaxMaterial* Mtls()=0;   // Array  of GraphicsWindow Materials 
...
//		virtual void GetMaterial(MaxMaterial &mtl)=0;  // Why do we need this?
...
// mjm - end
		...
		MaxMaterial* Mtls() { return node->Mtls(); }    
