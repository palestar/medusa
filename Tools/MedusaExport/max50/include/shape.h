...
class BezierShape : public BaseInterfaceServer {
	...
	public:
		...
		CoreExport void		Render(GraphicsWindow *gw, MaxMaterial *ma, RECT *rp, int compFlags, int numMat);
		CoreExport void		RenderGizmo(GraphicsWindow *gw);
		CoreExport BOOL		Select(GraphicsWindow *gw, MaxMaterial *ma, HitRegion *hr, int abortOnHit = FALSE);
		...
		CoreExport BOOL 	SubObjectHitTest(GraphicsWindow *gw, MaxMaterial *ma, HitRegion *hr,
		...
		CoreExport float FindSegmentPoint(int poly, int segment, GraphicsWindow *gw, MaxMaterial *ma, HitRegion *hr, int ptype = PARAM_SIMPLE);
