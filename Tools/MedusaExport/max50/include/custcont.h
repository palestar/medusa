...
typedef LRESULT CALLBACK PaintProc(HDC hdc, Box2 rect, BOOL in, BOOL checked, BOOL enabled);
...
class IOffScreenBuf {
	public:
		virtual HDC GetDC()=0;
		virtual void Erase(Box2 *rct=NULL)=0;
		virtual void Blit(Box2 *rct=NULL)=0;
