...
class DefNoteTrack : public NoteTrack {
	public:
		...
		CoreExport int HitTestTrack(TrackHitTab& hits,Box2& rcHit,Box2& rcTrack,float zoom,int scroll,DWORD flags );
		CoreExport int PaintTrack(ParamDimensionBase *dim,HDC hdc,Box2& rcTrack,Box2& rcPaint,float zoom,int scroll,DWORD flags );
