...
class Mesh : public BaseInterfaceServer {
	...
	private:
		...
		BOOL		CanDrawStrips(DWORD rndMode, MaxMaterial *mtl, int numMtls);
		...
		bool		CanDrawTriStrips(DWORD rndMode, int numMtls, MaxMaterial *mtl);
		bool		BuildTriStrips(DWORD rndMode, int numMtls, MaxMaterial *mtl);
		void		TriStripify(DWORD rndMode, int numTex, TVFace *tvf[], TriStrip *s, StripData *sd, int vtx);
		void 		Draw3DTriStrips(IHardwareShader *phs, int numMat, MaxMaterial *ma);
		void 		Draw3DWireTriStrips(IHardwareShader *phs, int numMat, MaxMaterial *ma);
	...
	public:
		...
		DllExport void		render(GraphicsWindow *gw, MaxMaterial *ma, RECT *rp, int compFlags, int numMat=1, InterfaceServer *pi = NULL);
		DllExport BOOL		select(GraphicsWindow *gw, MaxMaterial *ma, HitRegion *hr, int abortOnHit = FALSE, int numMat=1);
		DllExport void		snap(GraphicsWindow *gw, SnapInfo *snap, IPoint2 *p, Matrix3 &tm);
		DllExport BOOL 		SubObjectHitTest(GraphicsWindow *gw, MaxMaterial *ma, HitRegion *hr,
		...
		DllExport void 		DrawStrips(GraphicsWindow *gw, MaxMaterial *ma, int numMat);
		DllExport void 		Draw3DStrips(GraphicsWindow *gw, MaxMaterial *ma, int numMat);
		DllExport void 		Draw3DWireStrips(GraphicsWindow *gw, MaxMaterial *ma, int numMat);
