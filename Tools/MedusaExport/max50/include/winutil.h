...
void CoreExport GetClientRectP( HWND hwnd, Box2 *rect );
void CoreExport DrawIconButton( HDC hdc, HBITMAP hBitmap, Box2& wrect, Box2& brect, BOOL in );
...
CoreExport void DrawMAXIcon(HDC hDC, Box2 &r, HIMAGELIST hList32, HIMAGELIST hList16, int index);
