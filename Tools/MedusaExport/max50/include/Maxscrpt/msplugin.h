...
//	void			CopySubTexmap(HWND hwnd, int ifrom, int ito) { MtlBase::CopySubTexmap(hwnd, ifrom, ito); }     
	...
	void			SetupGfxMultiMaps(TimeValue t, MaxMaterial *mtl, MtlMakerCallback &cb) { MtlBase::SetupGfxMultiMaps(t, mtl, cb); }
...
//	void			DeactivateMapsInTree() { MtlBase::DeactivateMapsInTree(); }     
	...
	void			SetupGfxMultiMaps(TimeValue t, MaxMaterial *mtl, MtlMakerCallback &cb) { delegate->SetupGfxMultiMaps(t, mtl, cb); }
