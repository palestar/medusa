...
class SClassUIInfo
	...
	CoreExport virtual bool DrawRepresentation(SClass_ID superClassID, COLORREF bkColor, HDC hDC, Box2 &rect) { return false; }
	};
...
public:
	...
	bool DrawRepresentation(COLORREF bkColor, HDC hDC, Box2 &rect) { return FALSE; }
};
