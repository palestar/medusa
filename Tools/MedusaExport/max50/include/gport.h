...
class GPort {
	public:
		...
		virtual void DisplayMap(HDC hdc, Box2& drect,int xsrc, int ysrc, UBYTE *map, int bytesPerRow)=0;
		...
		virtual void DisplayMap(HDC hdc, Box2& dest, Box2& src, UBYTE *map, int bytesPerRow)=0; 
		...
		virtual void DitherColorSwatch(HDC hdc, Box2& r, Color c)=0;
