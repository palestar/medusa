...
class ViewportDisplayCallback {
	public:
		...
		virtual void GetViewportRect( TimeValue t, ViewExp *vpt, Box2 *rect )=0;
...
//		virtual void SetRendMaxPixelSize(float s)=0;
	...
	//watje this zooms the active viewport or all to the specified bounding box which is in world space
		...
		virtual void ConvertMtl(TimeValue t, MaxMaterial &gm, Mtl *mtl,  BOOL doTex, int subNum, float vis, BOOL &needDecal, INode *node, BitArray *needTex, GraphicsWindow *gw)=0;
