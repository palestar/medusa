...
class IAdjustMultipleTangents {
	public:
		virtual void AdjustInitialTangents(TrackHitRecord hit,ParamDimensionBase *dim,Box2& rcGraph,
		...
		virtual void AdjustSecondaryTangents(DWORD hitFlags,ParamDimensionBase *dim,Box2& rcGraph,
