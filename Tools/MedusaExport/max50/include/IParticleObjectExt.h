...
public:
	...
	FN_1(kNumberOfRenderMeshes,	TYPE_INT,			NumberOfRenderMeshes,		TYPE_TIMEVALUE );
	...
	virtual int NumberOfRenderMeshes(TimeValue t) { return 0; }
