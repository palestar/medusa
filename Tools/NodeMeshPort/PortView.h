...
public:
	...
	CString	m_TriangleCount;
	CString	m_VertexCount;
	BOOL	m_SnapVerticies;
...
protected:
	...
	//{{AFX_MSG(CPortView)
	afx_msg void OnMakeCube();
	afx_msg void OnMakeSphere();
	afx_msg void OnMaterialBrowse();
	afx_msg void OnMaterialProperties();
	afx_msg void OnUpdateNode();
	afx_msg void OnPositionRotation();
	//}}AFX_MSG
	DECLARE_MESSAGE_MAP()
};
